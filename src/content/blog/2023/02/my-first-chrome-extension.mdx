...
\*\***Update:** See [Introducing Google Workspace Zoom Default](../03/introducing-google-workspace-zoom-default.mdx) for an update!\*\*
...
<blockquote class="twitter-tweet">
  ...
  &mdash; Mitch Friedman (@mitchfriedman5){" "}
